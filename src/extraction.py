...
def enrich_dataset(dataset_path, rawdata_path ,dataset):
    ...
    enriched_dataset = enriched_dataset.rename(columns={
        "Modulus (Young's Tensile stress - Cursor)": "Young's Modulus",
        "Tensile stress at Break (Standard)": "Tensile Strenght",
        "Tensile strain at Break (Standard)": "Elongation at Break"
    })
    #Converting in float
